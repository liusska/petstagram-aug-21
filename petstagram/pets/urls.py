...
from petstagram.pets.views import list_pets, pet_details,\
    like_pet, create_pet, edit_pet, delete_pet, comment_pet

urlpatterns = [
    path('', list_pets, name='list pets'),
    path('details/<int:pk>', pet_details, name='details pets'),
